...
all: imageRender punch_cut solid_wall boxed_wall punch_cut_with_screwmount solid_wall_with_screwmount hive_for_mk3s_plus_buildplate business_card_holders punch_cut_no_base double_sized_no_base double_sized
...
# Cable Hives (Square)
	...
	openscad -m make -D nb_slots_X=1 -D nb_slots_Y=1 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./png/cable_hive_punch_cut_no_base_1x1.png ${MODELFILE}
	openscad -m make -D nb_slots_X=2 -D nb_slots_Y=2 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./png/cable_hive_punch_cut_no_base_2x2.png ${MODELFILE}
	openscad -m make -D nb_slots_X=3 -D nb_slots_Y=3 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./png/cable_hive_punch_cut_no_base_3x3.png ${MODELFILE}
	openscad -m make -D nb_slots_X=4 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./png/cable_hive_punch_cut_no_base_4x5.png ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=2 -D nb_slots_Y=2 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -o ./png/cable_hive_double_sized_no_base_2x2.png ${MODELFILE}
	openscad -m make -D nb_slots_X=3 -D nb_slots_Y=3 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -o ./png/cable_hive_double_sized_no_base_3x3.png ${MODELFILE}
	openscad -m make -D nb_slots_X=4 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -o ./png/cable_hive_double_sized_no_base_4x5.png ${MODELFILE}
...
# Fits Prusa MK3S+ build plate (MK3S+ build volume is 25×21×21 cm)
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./png/cable_hive_punch_cut_no_base_6x5.png ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -D I_want_reduced_base=true -o ./png/cable_hive_double_sized_no_base_6x5.png ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./png/cable_hive_punch_cut_no_base_6x6.png ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -D I_want_reduced_base=true -o ./png/cable_hive_double_sized_no_base_6x6.png ${MODELFILE}
...
# Business Card Hive (Fits within maximum volume of MK3S+, where it's build volume is 25×21×21 cm)
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D I_want_stepped_slope_cuts=true -D cable_slot_lower_height=10 -o ./png/businesscard_hive_6x5.png ${MODELFILE}
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D I_want_stepped_slope_cuts=true -D cable_slot_lower_height=10 -o ./png/businesscard_hive_6x6.png ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D I_want_smooth_slope_cuts=true -D cable_slot_lower_height=10 -o ./png/businesscard_hive_slope_6x6.png ${MODELFILE}
...
punch_cut_no_base:
	openscad -m make -D nb_slots_X=1 -D nb_slots_Y=1 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./stl/cable_hive_punch_cut_no_base_1x1.stl ${MODELFILE}
	openscad -m make -D nb_slots_X=2 -D nb_slots_Y=2 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./stl/cable_hive_punch_cut_no_base_2x2.stl ${MODELFILE}
	openscad -m make -D nb_slots_X=3 -D nb_slots_Y=3 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./stl/cable_hive_punch_cut_no_base_3x3.stl ${MODELFILE}
	openscad -m make -D nb_slots_X=4 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./stl/cable_hive_punch_cut_no_base_4x5.stl ${MODELFILE}
...
double_sized_no_base:
	openscad -m make -D nb_slots_X=2 -D nb_slots_Y=2 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -o ./stl/cable_hive_double_sized_no_base_2x2.stl ${MODELFILE}
	openscad -m make -D nb_slots_X=3 -D nb_slots_Y=3 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -o ./stl/cable_hive_double_sized_no_base_3x3.stl ${MODELFILE}
	openscad -m make -D nb_slots_X=4 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -o ./stl/cable_hive_double_sized_no_base_4x5.stl ${MODELFILE}
...
hive_for_mk3s_plus_buildplate:
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./stl/cable_hive_punch_cut_no_base_6x5.stl ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -D I_want_reduced_base=true -o ./stl/cable_hive_double_sized_no_base_6x5.stl ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_reduced_base=true -o ./stl/cable_hive_punch_cut_no_base_6x6.stl ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D lengthwise_cuts_count=2 -D I_want_reduced_base=true -o ./stl/cable_hive_double_sized_no_base_6x6.stl ${MODELFILE}
...
business_card_holders:
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D I_want_stepped_slope_cuts=true -D cable_slot_lower_height=10 -o ./stl/businesscard_hive_6x5.stl ${MODELFILE}
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D I_want_stepped_slope_cuts=true -D cable_slot_lower_height=10 -o ./stl/businesscard_hive_6x6.stl ${MODELFILE}
	...
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=6 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=false -D I_want_lengthwise_cuts=true -D I_want_smooth_slope_cuts=true -D cable_slot_lower_height=10 -o ./stl/businesscard_hive_slope_6x6.stl ${MODELFILE}
