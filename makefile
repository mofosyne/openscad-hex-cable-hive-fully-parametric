...
all: imageRender punch_cut solid_wall boxed_wall punch_cut_with_screwmount solid_wall_with_screwmount
...
# Business Card Hive
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=true -D I_want_lengthwise_cuts=true -D punch_corner_hole_count=2 -D cable_slot_height=60 -o ./png/businesscard_hive_6x5.png ${MODELFILE}
...
business_card_holders:
	openscad -m make -D nb_slots_X=6 -D nb_slots_Y=5 -D I_want_side_wall_punch=true  -D I_want_a_surrounding_wall=false -D I_want_mounting_screw_holes=true -D I_want_lengthwise_cuts=true -D punch_corner_hole_count=2 -D cable_slot_height=60 -o ./stl/businesscard_hive_6x5.stl ${MODELFILE}
